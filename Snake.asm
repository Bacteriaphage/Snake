...
;********************************************************************************************************
;                
;       将数据显示在屏幕上   Display pixel on the screen   
;
;********************************************************************************************************
DISPLAY:
        CLR    OE
...
;****************************************************************************************************        
;        
;      遍历数组中的数据并转换到显示数据块上  traverse the array and transmit the data to display module
;        
;**************************************************************************************************** 
PRE_TRA:  
        MOV     R5,     TEMP1
...
;******************************************************************************************************************                
;        
;       按键中断以及定时器中断       I/O interrupt and clock interrupt
;
;******************************************************************************************************************
INTE0:
        MOV     C,      20H.0
